import Reto_semanal_dos, string
from Reto_semanal_dos import registrar_sql as registro, evaluar_listas as evaluacion, recorrer_cadena as recorrer,variables as cadenita

nombre_usuario = input('\n\t Haga usted el enorme favor de digitar su preciado y valiosisimo nombre, porfis 😁: ')
...
answer = input('\n\t Le gustaría comenzar a registrar bases de datos basadas en formatos de lista (Y/N)? ')
while(answer != 'Y' and answer != 'y' and answer != 'n' and answer != 'N'):
    answer = input(f'\t Mi queridisimo {nombre_usuario}, haga usted el enorme favor de digitar correctamente su respuesta, no sea malo 👺, (Y/N): ')
...
while(answer == 'y' or answer == 'Y'):
    ...
    answer = input('\n Le gustaría continuar digitando listas (Y/N)? ')
    while(answer != 'Y' and answer != 'y' and answer != 'n' and answer != 'N'):
...
cont_tres = 0
print('\n\t Resultados de las listas originales digitadas por el usuario')
for i in fixture:
    cont_tres += 1
